...
fn named_color_to_rgb(color: NamedColor) -> TermColor {
    match color {
        ...
        NamedColor::BrightGreen => TermColor::new(0xc5, 0xd1, 0x7c),
        NamedColor::BrightYellow => TermColor::new(0xf5, 0xd5, 0x8e),
        NamedColor::BrightBlue => TermColor::new(0x9d, 0xb7, 0xd1),
        NamedColor::BrightMagenta => TermColor::new(0xc7, 0xab, 0xd0),
        NamedColor::BrightCyan => TermColor::new(0xa5, 0xd1, 0xca),
